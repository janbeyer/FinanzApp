...
import wbh.finanzapp.access.AnalysisDataSource;

/**
 * This activity has the ability to create a analysis of all transactions in an given time interval.
 *
 */
public class AnalysisActivity extends AbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonAddProfile = findViewById(R.id.button_add_analysis);
